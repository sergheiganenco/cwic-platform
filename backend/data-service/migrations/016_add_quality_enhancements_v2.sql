...
-- Enhanced Data Quality Features (v2 - CORRECTED TYPES)

-- Table for healing attempts
CREATE TABLE IF NOT EXISTS quality_healing_attempts (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  issue_id BIGINT NOT NULL REFERENCES quality_issues(id) ON DELETE CASCADE,
...
-- Add new columns to existing quality_issues table (already exist, skipping)
